...
zc.bp = function () {
    ...
    return localhostPath + (projectName!='/mdhy'?'':projectName);
};
/**
* 获取小星星
* */
    ...
    saveUploadImg: function (btn, view) {
        ...
        formObj.form.doAction('submit', {
            ...
            success: function (response, options) {
                ...
                if (!result.success) {
                    Ext.MessageBox.alert('温馨提示', result.message);
                    return;
                }
            ...
            failure: function (response, options) {
                Ext.MessageBox.alert('温馨提示', options.result.message);
            }
        });
    },
    ...
    * */
    insertImg: function (view, data) {
        ...
        if(url.indexOf('http')>=0){
        	str='<img src="'+url + '" border="0" ';
        }else{
        	str='<img src="'+ zc.bp()+ "/"+url + '" border="0" ';
        }
