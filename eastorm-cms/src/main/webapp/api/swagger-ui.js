...
(function() {
  ...
  SwaggerUi = (function(_super) {
    ...
    SwaggerUi.prototype.buildUrl = function(base, url) {console.log(base+":"+url)
      var parts;
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        param = _ref[_i];
        type = param.type || param.parameterType.absoluteType;
        //console.log(type)
    ...
    OperationView.prototype.addParameter = function(param, consumes) {
      ...
      //console.log(paramView.render().el)
    ...
    OperationView.prototype.showStatus = function(data) {
      ...
      response_body = pre;
      var spath='http://'+window.location.host;
      $(".request_url").html("<pre>"+spath+"</pre>");
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.template = function() {
        if(this.model.allowableValues==null||this.model.allowableValues.values==null||this.model.allowableValues.values.length<=0){
            this.model.isList=false;
        }
