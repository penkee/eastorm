...
(function() {
  ...
  SwaggerModel = (function() {
    ...
    function SwaggerModel(modelName, obj) {
      ...
      for (propertyName in obj.properties) {
        ...
        //if('登录'==obj.id){
        	//console.log(obj.id);
        	//console.log(obj.properties[propertyName])
       // }
    ...
    SwaggerModel.prototype.setReferencedModels = function(allModels) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        //console.log(type)
        if('array'==type){//返回list内部的bean解析 added by pengkun at 2017-4-24
            type=prop.refDataType.absoluteType ||prop.refDataType;
            console.log(prop)
            prop.dataTypeWithRef='array['+type+']';
        }
         if(prop.name=='lastLoginTime'){
  ...
  SwaggerModelProperty = (function() {
    ...
    function SwaggerModelProperty(name, obj) {
      this.name = name;
      this.dataType = obj.type.absoluteType || obj.type;
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces) {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        parameter = _ref1[_i];
        parameter.name = parameter.name || parameter.type || parameter.parameterType.absoluteType;
        type = ''+(parameter.type || parameter.parameterType.absoluteType);
    ...
    SwaggerOperation.prototype.urlify = function(args) {
      var param, queryParams, reg, url, _i, _j, _len, _len1, _ref, _ref1;this.resource.basePath='http://'+window.location.host+'/eastorm-cms';
      url = this.resource.basePath + this.pathJson()+"?openId=3463446&memberId=D37DCA73A48E506D4A926B306A9837C1&timestamp=1499491269428&signature=942e467e36a20b584bcf4845672e66b5";
